...
def main():
    ...
    out_file_att_debug = codecs.open(opt.output + '.att_debug', 'w', 'utf-8') # CUSTOM CHANGE
    ...
    for batch in test_data:
        ...
        for pred_sents, gold_sent, pred_score, gold_score, src_sent in z_batch:
            ...
            if opt.attn_debug: 
                ...
                src_words = get_src_words(src_sent, translator.fields["src"].vocab.itos)

                out_file_att_debug.write("0 ||| " + tgt_words + " ||| 0 ||| " + src_words + " ||| 0 0")
                ...
                for row in att_matrix:
                    ...
                    out_file_att_debug.write("{:.15f}".format(0)) # corresponds to the source EOS symbol
                    out_file_att_debug.write('\n')
